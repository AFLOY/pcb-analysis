"""PCB stackup description for the 2.5D multilayer operator.
...
class Stackup:
    ...
    def __post_init__(self) -> None:
        ...
        if len(self.layer_names) != len(self.z_mm):
    ...
    def dual_sided(
        ...
        *,
        ...
        return cls(layer_names=(front, back), z_mm=(0.0, -float(board_thickness_mm)))
    ...
    def separation_m(self, layer_a: int, layer_b: int) -> float:
        return float(abs(self.z_m[layer_a] - self.z_m[layer_b]))
