"""Build the emc C++ extension in place.

Usage: ``python -m emc.tiled_dipole_superposition.native.build [--no-openmp]``
"""
...
def build(*, openmp: bool = True, verbose: bool = True) -> Path:
    ...
    return compile_extension(
        here / "dipole_fields.cpp", "_dipole_native", here.parent, openmp=openmp, verbose=verbose
    )
