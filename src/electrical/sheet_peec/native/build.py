"""Build the sheet PEEC pFFT C++ extension in place.

Usage: ``python -m electrical.sheet_peec.native.build [--no-openmp]``
"""
...
def build(*, openmp: bool = True, verbose: bool = True) -> Path:
    ...
    return compile_extension(here / "pfft_near.cpp", "_sheet_pfft_native", here.parent, openmp=openmp, verbose=verbose)
